...
// Узел-прошивальщик, если он есть в сети: имя, адрес и когда объявлялся в последний раз.
// Образ уходит к нему по сети, поэтому адрес и нужен; пустой адрес — прошивальщика нет.
